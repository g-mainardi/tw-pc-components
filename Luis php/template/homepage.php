<section>
        ...
        <section >    
            <div class="container">
            <a href="#"><img src="immagini/motherboard.jpg" alt=""></a>
             </div>
            <h2>SCHEDE MADRI</h2>
        ...
        <section >    
            <div class="container">
            <a href="#"><img src="immagini/cpu.jpg" alt=""></a>
        </div>
            <h2>PROCESSORI</h2>
            <p>scegli tra la vasta gamma di schede madri quella che fa al caso tuo</p>
            <a class="link1" href="#">Scopri di più...</a> 
        ...
        <section >    
            <div class="container">
            <a href="#"><img src="immagini/PSU.jpg" alt=""></a>
        </div>
            <h2>ALIMENTATORI</h2>
            <p>scegli tra la vasta gamma di schede madri quella che fa al caso tuo</p>
            <a class="link1" href="#">Scopri di più...</a> 
        ...
        <section >    
            <div class="container">
            <a href="#"><img src="immagini/RAM.jpg" alt=""></a>
        </div>
            <h2>RAM</h2>
            <p>scegli tra la vasta gamma di schede madri quella che fa al caso tuo</p>
            <a class="link1" href="#">Scopri di più...</a> 
        ...
        <section >    
            <div class="container">
            <a href="#"><img src="immagini/case.jpg" alt=""></a>
        </div>
            <h2>CASE</h2>
            <p>scegli tra la vasta gamma di schede madri quella che fa al caso tuo</p>
            <a class="link1" href="#">Scopri di più...</a> 
